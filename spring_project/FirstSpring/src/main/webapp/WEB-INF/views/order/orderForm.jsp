...
<body>
	...
	<form method="post">
		<table border="1">
			...
			<tr>
				<td>주의</td>
				<td><input type="number" name="orderItems[0].remark"></td>
			</tr>
			...
			<tr>
				<td>주의</td>
				<td><input type="number" name="orderItems[1].remark"></td>
			</tr>
			...
			<tr>
				<td>주의</td>
				<td><input type="number" name="orderItems[2].remark"></td>
			</tr>
			...
			<tr>
				<td>주의</td>
				<td><input type="number" name="orderItems[3].remark"></td>
			</tr>
